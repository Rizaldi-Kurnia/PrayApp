...
import 'package:pray_app/header_content.dart';
import 'package:pray_app/list_jadwal.dart';
import 'package:pray_app/model/ResponseJadwal.dart';

void main() {
  runApp(MaterialApp(debugShowCheckedModeBanner: false, home: MyHomeScreen()));
}
...
class _MyHomeScreenState extends State<MyHomeScreen> {
  ...
  void initState() {
    if (_locationController.text.isEmpty || _locationController.text == null) {
      _locationController.text = 'Bekasi';
    }
    super.initState();
  }
            ...
            children: <Widget>[
              Tooltip(
                ...
                child: IconButton(
                    ...
                    onPressed: () {
                      _showDiaologEditLocation(context);
                    }),
              ),
            ],
          ),
  ...
  void _showDiaologEditLocation(BuildContext context) async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
